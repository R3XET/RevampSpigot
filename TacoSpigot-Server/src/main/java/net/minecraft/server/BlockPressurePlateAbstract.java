...
public abstract class BlockPressurePlateAbstract extends Block {
    ...
    protected void a(World world, BlockPosition blockposition, IBlockData iblockdata, int i) {
        ...
        if (!flag1 && flag) {
            world.makeSound((double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.1D, (double) blockposition.getZ() + 0.5D, "random.clock", 0.3F, 0.5F);
        } else if (flag1 && !flag) {
            world.makeSound((double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.1D, (double) blockposition.getZ() + 0.5D, "random.clock", 0.3F, 0.6F);
        }
