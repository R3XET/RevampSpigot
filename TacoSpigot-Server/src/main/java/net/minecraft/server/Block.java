...
public class Block {
    ...
    public int k() {
        //TODO ADDED CODE
        if (this.material == Material.PUMPKIN && !Settings.IMP.SETTINGS.ENTITY.PISTON_BREAK_PUMPKIN_MELON)
            return 0;
        //TODO ADDED CODE
    ...
    public static void S() {
        ...
        //TODO ADDED CODE
        //a(10, "flowing_lava", (new BlockFlowing(Material.LAVA)).c(RevampSpigot.getInstance().getLavaDurability()).a(1.0F).c("lava").K());
        //a(11, "lava", (new BlockStationary(Material.LAVA)).c(RevampSpigot.getInstance().getLavaDurability()).a(1.0F).c("lava").K());
        //TODO ADDED CODE
        ...
        //TODO ADDED CODE
        //a(19, "sponge", (new BlockSponge()).c(Settings.IMP.SETTINGS.PERFORMANCE.TNT.BETTER_SPONGE_MECHANICS ? 0.0F : 0.6F).b(0.6F).a(h).c("sponge"));
        //TODO ADDED CODE
        ...
        //TODO ADDED CODE
        //a(49, "obsidian", (new BlockObsidian()).c(50.0F).b(RevampSpigot.getInstance().getObsidianDurability()).a(Block.i).c("obsidian"));
        //TODO ADDED CODE
        ...
        //TODO ADDED CODE
        if (Settings.IMP.SETTINGS.PERFORMANCE.ALTERNATIVE_REDSTONE_ALGORITHM) {
            a(55, "redstone_wire", (new AlternativeBlockRedstoneWire()).c(0.0F).a(e).c("redstoneDust").K());
        } else {
        ...
        //TODO ADDED CODE
        //a(145, "anvil", (new BlockAnvil()).c(5.0F).a(p).b(RevampSpigot.getInstance().getAnvilDurability()).c("anvil"));
        //TODO ADDED CODE
