...
public class EntityTrackerEntry {
    ...
    public boolean c(EntityPlayer entityplayer) {
        ...
        //TODO ADDED CODE
        if (Settings.IMP.SETTINGS.PERFORMANCE.TNT.INVIS_TNT && this.tracker.isTNT && entityplayer.tntDisabled) {
            return false;
        }
        if (Settings.IMP.SETTINGS.PERFORMANCE.TNT.INVIS_SAND && this.tracker.isSand && entityplayer.sandDisabled) {
            return false;
        }
        if (Settings.IMP.PACKET_LIMITER.TNT_SAND.TNT_SAND_PACKET_LIMITER_ENABLED && (this.tracker.isTNT || this.tracker.isSand)) {
            entityplayer.sentPacket();
            if (entityplayer.packetsPerSecond > Settings.IMP.PACKET_LIMITER.TNT_SAND.MAX_TNT_AND_SAND_PPS) {
                return false;
            }
        }
        //TODO ADDED CODE
    ...
    private Packet c() {
        ...
        if (this.tracker instanceof EntityItem) {
            ...
            if (this.tracker instanceof EntityFireball) {
                ...
                //TODO ADDED CODE
                if (Settings.IMP.SETTINGS.PERFORMANCE.TNT.DO_NOT_SHOW_TNT_EXPLOSIONS)
                    return null;
                //TODO ADDED CODE
                ...
                //TODO ADDED CODE
                if (Settings.IMP.SETTINGS.PERFORMANCE.DO_NOT_SHOW_FALLING_BLOCKS)
                    return null;
                //TODO ADDED CODE
                ...
                //TODO ADDED CODE
                if ((entityfallingblock.getBlock().getBlock()).material == Material.SAND &&
                        !Settings.IMP.SETTINGS.PERFORMANCE.SHOW_FALLING_SAND)
                    return null;
                //TODO ADDED CODE
