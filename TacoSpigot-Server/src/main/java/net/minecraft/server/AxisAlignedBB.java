...
public class AxisAlignedBB {
    ...
    public AxisAlignedBB(AxisAlignedBB var1) {
        this.a = var1.a;
        this.b = var1.b;
        this.c = var1.c;
        this.d = var1.d;
    ...
    public double volume() {
        return (this.d - this.a) * (this.e - this.b) * (this.f - this.c);
    }
