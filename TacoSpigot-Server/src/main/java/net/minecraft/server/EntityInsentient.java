...
public abstract class EntityInsentient extends EntityLiving {
    ...
    public void m() {
        super.m();
        //TODO ADDED CODE
        if (!Settings.IMP.SETTINGS.MISCELLANOUS.DO_ENTITIES_PICK_UP_ITEMS)
            return;
        //TODO ADDED CODE
        this.world.methodProfiler.a("looting");
        if (!this.world.isClientSide && this.bY() && !this.aP && this.world.getGameRules().getBoolean("mobGriefing")) {
            List<Entity> list = this.world.a(EntityItem.class, this.getBoundingBox().grow(1.0D, 0.0D, 1.0D));
    ...
    protected final void doTick() {
        ...
        if (this.ticksLived % Settings.IMP.SETTINGS.PERFORMANCE.TICKS.TICKS_BETWEEN_ENTITY_DESPAWN_CHECKS == 0)
            D();
        this.world.methodProfiler.b();
        if (this.fromMobSpawner || (Settings.IMP.SETTINGS.PERFORMANCE.DISABLE_MOB_ABI && (!Settings.IMP.SETTINGS.PERFORMANCE.ONLY_DISABLE_MOB_AI_FOR_SPAWNER_MOB || this.isFromMobSpawner))) {
    ...
    */
    ...
    //TODO ADDED CODE
    public boolean canSpawn() {
        return (this.world.a(getBoundingBox(), this) && (!Settings.IMP.SETTINGS.ENTITY.SPAWNER_BLOCK_CHECKS || this.world.getCubes(this, getBoundingBox()).isEmpty()) && (!Settings.IMP.SETTINGS.ENTITY.WATER_PREVENT_SPAWN_CHECK || !this.world.containsLiquid(getBoundingBox())));
    }
    //TODO ADDED CODE
