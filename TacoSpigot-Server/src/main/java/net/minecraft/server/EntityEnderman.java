...
public class EntityEnderman extends EntityMonster {
    ...
    static class PathfinderGoalEndermanPickupBlock extends PathfinderGoal {
        ...
        public void e() {
            ...
            //TODO ADDED CODE
            int i = (int)FastMath.floor(this.enderman.locX - 2.0D + random.nextDouble() * 4.0D);
            int j = (int)FastMath.floor(this.enderman.locY + random.nextDouble() * 3.0D);
            int k = (int)FastMath.floor(this.enderman.locZ - 2.0D + random.nextDouble() * 4.0D);
            //TODO ADDED CODE
    ...
    static class PathfinderGoalEndermanPlaceBlock extends PathfinderGoal {
        ...
        public void e() {
            ...
            //TODO ADDED CODE
            int i = (int)FastMath.floor(this.a.locX - 1.0D + random.nextDouble() * 2.0D);
            int j = (int)FastMath.floor(this.a.locY + random.nextDouble() * 2.0D);
            int k = (int)FastMath.floor(this.a.locZ - 1.0D + random.nextDouble() * 2.0D);
            //TODO ADDED CODE
