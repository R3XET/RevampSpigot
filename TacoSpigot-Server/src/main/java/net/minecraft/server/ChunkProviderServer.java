...
public class ChunkProviderServer implements IChunkProvider {
    ...
    public void queueUnload(int i, int j) {
        //TODO ADDED CODE
        if (!Settings.IMP.SETTINGS.PERFORMANCE.DO_CHUNK_UNLOAD) return;
        //TODO ADDED CODE
        ...
        if (chunk != null) {
            ...
            //TODO ADDED CODE
            if (System.currentTimeMillis() - chunk.lastLoaded < Settings.IMP.SETTINGS.DEVELOPER_SETTINGS.CHUNK_UNLOAD_DELAY)
                return;
            //TODO ADDED CODE
    ...
    public Chunk getChunkAt(int i, int j, Runnable runnable) {
        ...
        if (chunk == null && loader != null && loader.chunkExists(world, i, j)) {
            if (runnable != null) {
                ...
                //TODO ADDED CODE
                if (Settings.IMP.SETTINGS.PERFORMANCE.LOAD_CHUNK_AGAIN_IF_NULL && chunk == null)
