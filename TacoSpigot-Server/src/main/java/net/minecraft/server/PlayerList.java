...
public abstract class PlayerList {
    ...
    public final List<EntityPlayer> players = new CopyOnWriteArrayList<>(); // CraftBukkit - ArrayList -> CopyOnWriteArrayList: Iterator safety
    ...
    public void a(NetworkManager networkmanager, EntityPlayer entityplayer) {
        ...
        onPlayerJoin(entityplayer, Settings.IMP.MESSAGES.DISABLE_JOIN_LEAVE_MESSAGES ? null : joinMessage);
        //TODO ADDED CODE
        ...
        if (Settings.IMP.SETTINGS.DEVELOPER_SETTINGS.IP_ADDRESSES_HIDDEN) {
            PlayerList.f.info(entityplayer.getName() + " logged in with entity id " + entityplayer.getId() + " at ([" + entityplayer.world.worldData.getName() + "]" + entityplayer.locX + ", " + entityplayer.locY + ", " + entityplayer.locZ + ")");
        } else {
    ...
    public void onPlayerJoin(EntityPlayer entityplayer, String joinMessage) { // CraftBukkit added param
        ...
        //TODO ADDED CODE
        ArmorEvents.check(this.cserver.getPlayer(entityplayer));
        //TODO ADDED CODE
