...
public class WorldServer extends World implements IAsyncTaskHandler {
    ...
    public void doTick() {
        ...
        //TODO ADDED CODE
        if (Settings.IMP.SETTINGS.PERFORMANCE.DO_CHUNK_UNLOAD) {
        ...
        if (this.e && block.getMaterial() != Material.AIR) {
            if (block.N()) {
                ...
                if (this.areChunksLoadedBetween(nextticklistentry.a.a(-b0, -b0, -b0), nextticklistentry.a.a(b0, b0, b0))) {
                    ...
                    //TODO ADDED CODE
                    if (iblockdata.getBlock().getMaterial() != Material.AIR && iblockdata.getBlock() == nextticklistentry.a()) {
                        this.stopPhysicsEvent = (Settings.IMP.SETTINGS.PERFORMANCE.DISABLE_BLOCK_PHYSICS_FOR_REDSTONE && (iblockdata.getBlock() instanceof BlockDiodeAbstract || iblockdata.getBlock() instanceof BlockRedstoneTorch));
                        iblockdata.getBlock().b(this, nextticklistentry.a, iblockdata, this.random);
                    }
                    //TODO ADDED CODE
                }
