...
import eu.revamp.spigot.events.autorespawn.PlayerAutoRespawnEvent;
import eu.revamp.spigot.events.autorespawn.PlayerPreAutoRespawnEvent;
...
public class EntityPlayer extends EntityHuman implements ICrafting {
    ...
    //TODO ADDED CODE
    public boolean tntDisabled = false;
    public boolean sandDisabled = false;
    public boolean pistonsDisabled = false;
    public boolean redstoneDisabled = false;

    public long packetsPerSecond = -1L;
    ...
    RevampSpigot eq = RevampSpigot.getInstance();
    ...
    public void die(DamageSource damagesource) {
        ...
        //TODO ADDED CODE
        String deathmessage = Settings.IMP.MESSAGES.DISABLE_DEATH_MESSAGES ? null : chatmessage.c();
        //TODO ADDED CODE
        ...
        //TODO ADDED CODE
        if (Settings.IMP.SETTINGS.AUTO_RESPAWN) {
            CraftPlayer craftPlayer = getBukkitEntity();
            Location deathLoc = craftPlayer.getLocation();
            PlayerPreAutoRespawnEvent ppare = new PlayerPreAutoRespawnEvent(craftPlayer, deathLoc);
            Bukkit.getPluginManager().callEvent(ppare);
            if (!ppare.isCancelled()) {
                craftPlayer.spigot().respawn();
                Bukkit.getPluginManager().callEvent(new PlayerAutoRespawnEvent((Player)craftPlayer, deathLoc, craftPlayer.getLocation()));
            }
        }
        //TODO ADDED CODE
    ...
    public void sentPacket() {
        if (System.currentTimeMillis() - this.startTime < 1000L) {
            this.intervalPackets = this.intervalPackets + 1L;
        } else {
