...
public class CraftScheduler implements BukkitScheduler {
    ...
    //TODO ADDED CODE
    public BukkitTask runTaskLaterNoPlugin(Runnable runnable, long delay) {
        return runTaskTimerNoPlugin(runnable, delay, -1L);
    }


    public BukkitTask runTaskTimerNoPlugin(Runnable runnable, long delay, long period) {
        if (delay < 0L)
            delay = 0L;
        if (period == 0L) {
            period = 1L;
