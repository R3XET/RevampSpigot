...
import eu.revamp.spigot.listener.FPSListener;
...
public final class CraftServer implements Server {
    ...
    private final String serverName = "RevampSpigot";
    ...
    //TODO ADDED CODE
    private RevampSettingsPlugin revampSettingsPlugin;
    //TODO ADDED CODE
    ...
    public void loadPlugins() {
        ...
        JavaPlugin listenerPlugin = new JavaPlugin("Listener") {

        };

        //TODO ADDED CODE
        new FPSListener(listenerPlugin);
        //TODO ADDED CODE
    ...
    public void enablePlugins(PluginLoadOrder type) {
        if (type == PluginLoadOrder.STARTUP) {
            ...
            //TODO ADDED CODE
            this.revampSettingsPlugin = new RevampSettingsPlugin();
            this.revampSettingsPlugin.enable();
            //TODO ADDED CODE
        }
    ...
    public boolean dispatchCommand(CommandSender sender, String commandLine) {
        Validate.notNull(sender, "Sender cannot be null");
        Validate.notNull(commandLine, "CommandLine cannot be null");
        if (!Bukkit.isPrimaryThread() && !Settings.IMP.SETTINGS.ASYNC.ALLOW_ASYNC_DISPATCH_COMMANDS) {
            final CommandSender fSender = sender;
            final String fCommandLine = commandLine;
            Bukkit.getLogger().log(Level.SEVERE, "Command Dispatched Async: " + commandLine);
            Bukkit.getLogger().log(Level.SEVERE, "Please notify author of plugin causing this execution to fix this bug! see: http://bit.ly/1oSiM6C", new Throwable());
            Waitable<Boolean> wait = new Waitable<Boolean>() {
                protected Boolean evaluate() {
                    return Boolean.valueOf(CraftServer.this.dispatchCommand(fSender, fCommandLine));
                }
            };
    ...
    public void reload() {
       ...
       /*
        ...
        //TODO ADDED CODE
        if (Settings.IMP.SETTINGS.ASYNC.ASYNC_BANS_AND_PROFILES_LOAD) {
            RevampSpigot.getInstance().getThread().requestTask(this::loadBanned);
        } else {
            loadBanned();
        }
        //TODO ADDED CODE
