...
public class ActivationRange
{
    ...
    public static void activateEntities(World world)
    {
        ...
        for ( Entity player : (List<Entity>) (List) world.players )
        {
            ...
            //TODO ADDED CODE
            int i = FastMath.floorToInt(maxBB.a / 16.0D);
            int j = FastMath.floorToInt(maxBB.d / 16.0D);
            int k = FastMath.floorToInt(maxBB.c / 16.0D);
            int l = FastMath.floorToInt(maxBB.f / 16.0D);
            //TODO ADDED CODE
