...
import eu.revamp.spigot.commands.FPSCommand;
import eu.revamp.spigot.commands.KnockbackCommand;
import eu.revamp.spigot.commands.RevampSpigotCommand;
...
public class SpigotConfig {
    ...
    private static void nettyThreads() {
        ...
        Bukkit.getLogger().log(Level.INFO, "Using {0} threads for Netty based IO", Settings.IMP.SETTINGS.DEVELOPER_SETTINGS.NETTY_THREADS);
    }
    ...
    private static void knockbackCommand() {
        commands.put("knockback", new KnockbackCommand("knockback"));
    }
    ...
    private static void playerSample() {
        ...
        Settings.SETTINGS.COMMANDS commands = Settings.IMP.SETTINGS.COMMANDS;
        SpigotConfig.commands.put("revampspigot", new RevampSpigotCommand("revampspigot"));
        if (commands.ADD_KILL_ENTITIES_COMMAND)
            SpigotConfig.commands.put("killentities", new KillEntitiesCommand("killentities"));
        /*if (commands.ADD_PING_COMMAND)
            SpigotConfig.commands.put("ping", new PingCommand());*/
        if (commands.ADD_SET_SLOTS_COMMAND)
            SpigotConfig.commands.put("setslots", new SetSlotsCommand("setslots"));

        if (commands.ADD_FPS_COMMAND)
            SpigotConfig.commands.put("fps", new FPSCommand("fps"));
    ...
    public static void setMobAI(boolean mobAI) {
        SpigotConfig.mobAI = mobAI;
    }

    private static void mobAI() {
        SpigotConfig.mobAI = getBoolean("mobAi", true);
    }
