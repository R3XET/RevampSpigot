package eu.revamp.spigot.events.anvil;
...
public class PrepareAnvilRepairEvent extends InventoryEvent implements Cancellable {
    ...
    public PrepareAnvilRepairEvent(HumanEntity repairer, InventoryView view, Block anvil, ItemStack first, ItemStack second, ItemStack result) {
        super(view);
        this.first = first;
        this.second = second;
        this.anvil = anvil;
