package eu.revamp.spigot.utils.item;
...
public class ItemBuilder {
    ...
    public ItemBuilder setNameWithArrows(String name) {
        ...
        itemMeta.setDisplayName(CC.translate(str + CC.ARROW_RIGHT + " " + name + " " + str + CC.ARROW_LEFT));
    ...
    public ItemBuilder setLore(List<String> lore) {
        ...
        lore.forEach(l -> translatedLore.add(CC.translate(l)));
