...
public class SitUtils {
    ...
    public static void sitPlayer(Player player) {
        ...
        try {
            ...
            Object entityCreeper = SitUtils.buildEntityCreeper(world, playerLocation);
    ...
    public static Object buildEntityCreeper(Object world, Location loc) throws Exception {
    ...
    public static void updateEntityLocation(Object entity, Location loc) throws Exception {
