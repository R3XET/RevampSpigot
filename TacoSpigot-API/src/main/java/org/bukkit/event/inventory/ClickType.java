...
public enum ClickType {
    ...
    WINDOW_BORDER_RIGHT,
    /**
     * The middle mouse button, or a "scrollwheel clock".
     */
    MIDDLE,
    /**
    ...
    public boolean isCreativeAction() {
        // Why use middle clock?
        return (this == ClickType.MIDDLE) || (this == ClickType.CREATIVE);
    }

    /**
     * Gets whether this ClickType represents a right clock.
     *
     * @return true if this ClickType represents a right clock
     */
    ...
    /**
     * Gets whether this ClickType represents a left clock.
     *
     * @return true if this ClickType represents a left clock
     */
